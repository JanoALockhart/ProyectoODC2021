...
/**
Función que devuelve el resultado de transformar el numero decimal desde su base de origen a base 10.
Parametros:
    -n(char*): Puntero al primer elemento de una cadena de caracteres que representara a un número en base de origen.
    -OBase(int*): Puntero a un entero que representará la base de origen en la que fue ingresada el número.
...
/**
Función que devuelve el resultado de transformar el numero decimal desde base 10 a una base destino.
Parametros:
